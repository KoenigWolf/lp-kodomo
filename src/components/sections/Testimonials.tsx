...
const testimonials = [
  {
    name: "佐藤 裕子",
    role: "小学5年生の母",
    comment: "子どもが自信を持ち、英語に興味を持つようになりました！初めは心配でしたが、帰国後の成長ぶりに驚いています。毎日楽しく過ごせたようで、また参加したいと言っています。",
    stars: 5,
  },
  {
    name: "田中 誠一",
    role: "中学2年生の父",
    comment: "初めての海外でも、しっかりサポートしてもらえて安心でした！現地スタッフの方の対応も素晴らしく、子どもも楽しく過ごせたようです。英語力も向上し、何より自信がついたのが一番の収穫でした。",
    stars: 5,
  },
  {
    name: "山田 美穂",
    role: "小学6年生の母",
    comment: "娘が「また行きたい！」と言うほど充実した留学でした。現地の友達もでき、SNSでやり取りしています。異文化への理解が深まり、視野が広がったと感じます。",
    stars: 5,
  },
];
