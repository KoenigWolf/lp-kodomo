        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="https://line.me" className="bg-white text-blue-600 p-2 rounded-full hover:bg-blue-100 transition-colors duration-200" aria-label="LINE公式アカウント">
                <MessageCircle size={20} />
              </Link>
              <Link href="https://instagram.com" className="bg-white text-blue-600 p-2 rounded-full hover:bg-blue-100 transition-colors duration-200" aria-label="Instagram公式アカウント">
                <Instagram size={20} />
              </Link>
              <Link href="https://facebook.com" className="bg-white text-blue-600 p-2 rounded-full hover:bg-blue-100 transition-colors duration-200" aria-label="Facebook公式ページ">
                <Facebook size={20} />
              </Link>
            </div>
          ...
          <div>
            ...
            <p className="text-blue-100 mb-3">最新のプログラム情報やお得な情報をメールでお届けします</p>
            <form className="flex">
              <input
                type="email"
                placeholder="メールアドレス"
